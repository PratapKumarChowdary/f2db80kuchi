...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Village App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Village App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Village App Login', user : req.user }); 
}); 
